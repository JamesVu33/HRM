...
import com.example.ihrm.core.errorHandler.GlobalErrorException
...
class ErrorInterceptor(
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (!response.isSuccessful) {
            ...
            when(response.code) {
                401 -> GlobalErrorException.UnauthorizedException(errorKey ?: "GLOBAL_ERROR_UNAUTHORIZED") // invalid token
                403 -> GlobalErrorException.NotPermissionException(errorKey ?: "GLOBAL_ERROR_FORBIDDEN") // permission not allow
                else -> null
